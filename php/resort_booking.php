...
<body style=" background-color: #f1fbff;">
    ...
    <!-- form -->
    <div class="container my-4 resort">
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form action="resort.php" method="post">
                    <div class="card">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="radio" name="room" value="Standard">Standard
                    ...
                    <a href="../hotel.html" class="btn btn-outline-success mt-4">Go Back</a>
                </form>
            </div>
        </div>
    </div>
