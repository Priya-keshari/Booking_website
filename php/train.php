...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (train_no, journey_from, journey_to, birth, date, name, age, phone, gender) values
         ('$train_no','$journey_from', '$journey_to', '$birth', '$date', '$name', '$age', '$phone', '$gender')";

        $result = $conn->query($query);
        header("Location: /hotel/train.html");
        exit();
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
        ...
        <style>
            body {
                background-image: url("img/photo-1442570468985-f63ed5de9086.jpeg");
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="train.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
