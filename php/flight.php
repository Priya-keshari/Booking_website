...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (name, dob, phone, email, departure_date, departure_time, departing_from, destination,
        passport_no, issue_date, expiry_date, address) values ('$name','$dob', '$phone', '$email', '$departure_date', 
        '$departure_time', '$departing_from', '$destination', '$passport_no', '$issue_date', '$expiry_date', '$address')";

        $result = $conn->query($query);
        header("Location: /hotel/flight.html");
        exit();
