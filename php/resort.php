...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (f_name, l_name, Phone, email, check_in, check_out, in_time, out_time, address, city, state, 
        room, adult, children) values ('$f_name','$l_name', '$Phone', '$email', '$check_in', '$check_out', '$in_time', 
        '$out_time', '$address', '$city', '$state', '$room', '$adult', '$children')";

        $result = $conn->query($query);
        header("Location: /hotel/hotel.html");
        exit();
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="hotel.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
