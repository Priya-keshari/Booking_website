...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (name, phone, p_location, d_location, p_date, p_time) values
         ('$name','$phone', '$p_location', '$d_location', '$p_date', '$p_time')";

        $result = $conn->query($query);
        header("Location: /hotel/cab.html");
        exit();
