...
<head>
    ...
    <style>
        body {
            background-image: url("../img/cab4.jpeg");
...
<body style=" background-color: #f1fbff;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../cab.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <!-- cab booking form -->
    <div class="container my-4 cab_booking">
        <div class="row">
                    ...
                    <form action="cab.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="d_location" class="form-control"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="time" name="p_time" class="form-control" required>
                            </div>
                            <div class="offset-md-9 col-md-3 my-4">
                                    <label>Amount</label>
    ...
    <!-- <div class="container my-5 train_booking">
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <div class="card">
                    <div class="card-header"
                        style="background-color: seagreen;color: white; height: 70px;padding: 15px;">
                        <center>
                            <h2>BOOK CAB NOW</h2>
                        </center>
                    </div>
                    <div class="card-body">
                        <form action="./php/cab.php" method="post">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>Name</label>
                                    ...
                                    <div class="col-md-12">
                                        <label>Pickup Location</label>
                                        <input type="text" name="p_location" class="form-control" placeholder="Enter an Origin Location">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Drop Location</label>
                                        <input type="text" name="d_location" class="form-control"
        ...
        <div class="container">
            <div class="row">
                <div class="offset-md-1 col-md-3">
                    <h5>MakeMyTrip</h5>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam ut consectetur voluptate ab!
                        Aspernatur vero earum delectus quisquam.</p>
                </div>
                <div class="offset-md-1 col-md-2">
                    <h5>Product Offering</h5>
                    <a href="flight.html">Flights</a><br>
                    <a href="hotel.html">Hotels</a><br>
                    <a href="package.html">Holidays in India</a><br>
                    <a href="cab.html">Cab Booking</a>
                </div>
                <div class="col-md-2">
                    <h5>MakeMyTrip</h5>
                    <a href="about.html">About Us</a><br>
                    <a href="carrer.html">Carrers</a><br>
                    <a href="#">Social Responsibility</a>
                </div>
                <div class="col-md-2">
                    <h5>About the sites</h5>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="offset-md-2 col-md-6">
                            <input type="email" class="form-control" placeholder="Email123@gmail.com"
                                style="height: 50px;">
                        </div>
                        <div class="col-md-4">
                            <a href="#"><button class="btn btn-warning"
                                    style="width: 100%;height: 50px;">SUBSCRIBE</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 my-2">
                    <center>
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="white"
                        ...
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white"
            ...
            <div class="row">
                <div class="offset-md-1 col-md-4">
                    <p>© 2023 MAKEMYTRIP PVT. LTD. Country India USA UAE</p>
                </div>
            </div>
            <br>
        </div>
