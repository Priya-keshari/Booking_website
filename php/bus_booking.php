        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../bus.html">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="container my-5 train_booking">
        <div class="row">
            <div class="offset-md-3 col-md-6">
                        ...
                        <div class="container my-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="n_pass" class="form-control" required>
                                </div>
                                <div class="offset-md-9 col-md-2 my-3">
                                    <label>Amount</label>
                ...
                <a href="/hotel/bus.html" class="btn btn-outline-success mt-4">Go Back</a>
            </div>
        </div>
    </div>
    <!-- footer -->
