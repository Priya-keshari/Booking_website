...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (departing_from, destination, departure_date, time, birth, n_pass) values
         ('$departing_from','$destination', '$departure_date', '$time', '$birth', '$n_pass')";

        $result = $conn->query($query);
        header("Location: /hotel/bus.html");
        exit();
