...
<body style=" background-color: #f1fbff;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../flight.html">
    ...
    <!-- image -->
    <img src="../img/flight.jpg" style="width: 100%;height: 450px;">
    <!-- flight reservation form -->
    <div class="container my-5 flight_res">
        <form action="flight.php" method="post">
            <div class="row my-4">
                <div class="offset-md-1 col-md-10">
                    <h1>FLIGHT RESERVATION</h1>
                    <h4>Please make sure that you fill in the name which is in your passport.</h4>
                    <div class="card my-5">
                        <div class="container my-4">
                            <div class="row">
                                <div class="col-md-12 mx-4">
                                    <h4><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="departing_from" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="passport_no" class="form-control" required>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="offset-md-4 col-md-2 my-4">
                                    <label>Amount</label>
